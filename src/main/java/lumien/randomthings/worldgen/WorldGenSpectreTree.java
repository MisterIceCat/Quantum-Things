...
public class WorldGenSpectreTree extends WorldGenAbstractTree
{
	...
	private static final IBlockState LEAF = ModBlocks.spectreLeaf.getDefaultState().withProperty(BlockSpectreLeaf.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenSpectreTree(boolean notify)
	{
		super(notify);
	}
