...
public class EntityFallingBlockSpecial extends Entity implements IEntityAdditionalSpawnData
{
	...
	public EntityFallingBlockSpecial(World worldIn, double x, double y, double z, IBlockState fallingBlockState)
	{
		super(worldIn);
